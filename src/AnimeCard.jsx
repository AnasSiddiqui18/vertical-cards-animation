...
const AnimeCard = ({ anime }) => {
    ...
    return (
        ...
        <div className="flex h-1/3 gap-x-8 justify-end py-5 mr-5 transition-all" id="victim" ref={cardsRef}>
            <div className="flex anime-card" id="victim_01">
                <img className="w-[200px] rounded-md shadow-md shadow-orange-300" src={anime.image.original} alt="#" />
            </div>
